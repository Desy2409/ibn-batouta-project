    ...
    <section id="portfolio" class="section-bg">
        <div class="container">
            ...
            <header class="section-header">
                <h3 class="section-title">Nos filières de formation</h3>
            </header>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <ul id="portfolio-flters">
                        ...
                        <li data-filter=".filter-app">Lettres et littératures arabes</li>
                        <li data-filter=".filter-card">Sciences de l'éducation</li>
                        <li data-filter=".filter-web">Etudes islamiques</li>
                    </ul>
                </div>
            </div>
            ...
            <div class="row portfolio-container">
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Langue Arabe</a></h4>
                            <p>Lettres et Littératures Arabes</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Sciences Coraniques</a></h4>
                            <p>Etudes islamiques</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Littérature Arabe et africaine</a></h4>
                            <p>Lettres et Littératures Arabes</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Tourisme et Loisirs</a></h4>
                            <p>Sciences de l'Education</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Dogmes et pensées islamiques</a></h4>
                            <p>Etudes islamiques</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-app wow fadeInUp" data-wow-delay="0.2s">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Traduction et Interprétariat</a></h4>
                            <p>Lettres et Littératures Arabes</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Education et Enseignement</a></h4>
                            <p>Sciences de l'Education</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-card wow fadeInUp" data-wow-delay="0.1s">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Communication et Journalisme</a></h4>
                            <p>Sciences de l'Education</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 portfolio-item filter-web wow fadeInUp" data-wow-delay="0.2s">
                    <div class="portfolio-wrap">
                        ...
                        <div class="portfolio-info">
                            <h4><a href="#">Finances islamiques</a></h4>
                            <p>Etudes islamiques</p>
                        </div>
                    </div>
                </div>
