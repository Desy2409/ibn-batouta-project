...
<section id="contact" class="section-bg">
    <div class="container" data-aos="fade-up">
        ...
        <div class="section-header">
            <h3 class="arabic_align">للاتصال بنا</h3>
            <p class="arabic_align">بصرف النظر عن دعمنا عبر الإنترنت الذي يعالج مخاوفك ، يمكنك الوصول إلينا هنا أو من خلال هذه القنوات: </p>
        </div>
        ...
        <div class="row contact-info">
            ...
            <div class="col-md-4">
                <div class="contact-address">
                    ...
                    <h3 class="arabic_align">تبوك</h3>
                    {{-- <address>A108 Adam Street, NY 535022, USA</address> --}}
                    <address class="arabic_align">{{ $about->geographic_location }}</address>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="contact-phone">
                    ...
                    <h3 class="arabic_align">رقم التليفون</h3>
            ...
            <div class="col-md-4">
                <div class="contact-email">
                    ...
                    <h3 class="arabic_align">بريد الالكتروني</h3>
        ...
        <div class="form">
            <form action="forms/contact.php" method="post" role="form" class="php-email-form">
                ...
                <div class="text-center arabic_align"><button type="submit">أرسل رسالة</button></div>
            </form>
        </div>
