        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 footer-links">
                    <h4>Liens utiles</h4>
                    <ul>
                        <li><i class="bi bi-chevron-right"></i> <a href="#">HOMEPAGE</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a href="#">IAIB</a></li>
                        <li><i class="bi bi-chevron-right"></i> <a href="#">OPPORTUNITIES</a></li>
                ...
                <div class="col-lg-3 col-md-6 footer-newsletter">
                    ...
                    <p>To receive our catalog with the new courses for free, subscribe to our newsletter.</p>
