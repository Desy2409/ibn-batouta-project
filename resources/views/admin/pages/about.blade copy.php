                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="vision_ar" placeholder="Renseignez la vision" rows="3">{{ $aboutArabic ? $aboutArabic->vision : '' }}</textarea>
                                    @error('vision_ar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="vision_en" placeholder="Renseignez la vision" rows="3">{{ $aboutEnglish ? $aboutEnglish->vision : '' }}</textarea>
                                    @error('vision_en')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="vision_fr" placeholder="Renseignez la vision" rows="3">{{ $aboutFrench ? $aboutFrench->vision : '' }}</textarea>
                                    @error('vision_fr')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="value_ar" placeholder="Renseignez la valeur" rows="3">{{ $aboutArabic ? $aboutArabic->value : '' }}</textarea>
                                    @error('value_ar')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="value_en" placeholder="Renseignez la valeur" rows="3">{{ $aboutEnglish ? $aboutEnglish->value : '' }}</textarea>
                                    @error('value_en')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="value_fr" placeholder="Renseignez la valeur" rows="3">{{ $aboutFrench ? $aboutFrench->value : '' }}</textarea>
                                    @error('value_fr')
                                        <span class="invalid-feedback" role="alert">
                                            <strong class="text-danger">{{ $message }}</strong>
                                        </span>
